  ...
  return (
    <>
      ...
      >
        ...
        >
          <NavLink
            className="navbar-brand font d-flex justify-content-center align-items-center  col-4"
            to="#"
          >
          ...
          <div
            className="collapse navbar-collapse  p-3 gap-3"
          ...
          >
            ...
            <ul
              className="d-flex gap-2 border-line mt-2 mb-2 mb-lg-2  col-4"
              role="search"
            >
              {AuthName ? (
                <>
